...
function ComparePage() {
  ...
  const featuredDimmed = !!featured && activeTab !== "All" && !featured.tags.includes(activeTab);
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                C<span style={{ color: "#18b4d4" }}>0</span>
                insiglieri Score
              </p>
              <p
                style={{
              ...
              >
                Security 30% · Proof of Reserves 25% · Compliance 20% · Liquidity 15% · Track Record
                10%
              </p>
            </div>
          </div>
