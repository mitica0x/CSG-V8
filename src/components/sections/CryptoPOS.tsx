      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            >
              Real-World <span className="gradient-cyan">Crypto Payments</span> at Scale
            </h2>
            <p className="text-lg leading-relaxed mb-10" style={{ color: "#8892a4" }}>
              ...
              crypto POS in Romania at Beach, Please! 2024 with 120,000+ attendees. Not a pilot. An
              operation.
            </p>
              ...
              <button
                ...
                onMouseEnter={(e) =>
                  ((e.currentTarget as HTMLElement).style.boxShadow =
                    "0 0 42px rgba(91,168,181,0.65)")
                }
                onMouseLeave={(e) =>
                  ((e.currentTarget as HTMLElement).style.boxShadow =
                    "0 0 22px rgba(91,168,181,0.38)")
                }
              >
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-sm leading-relaxed mb-8" style={{ color: "#8892a4" }}>
                  Romania's Black Sea Coast. In partnership with LUNU, Global Records, Bybit, and
                  Nuba — VIP guests purchased champagne and luxury experiences using crypto for the
                  ...
                  {[
                    ...
                    >
                      <p
                        ...
                        style={{ color: "#5BA8B5", fontFamily: "Geist, sans-serif" }}
                      >
                        {s.value}
                      </p>
