      ...
      <div className="max-w-2xl mx-auto px-6">
        ...
        >
          ...
          <h2
            ...
            style={{ fontSize: 'clamp(2rem, 5vw, 3.25rem)', color: '#f8fafc', letterSpacing: '-0.02em', marginBottom: '1.5rem' }}
          >
            Start Your Project
          </h2>
        ...
        {submitted ? (
          ...
          >
                ...
                {serviceOptions.map((s) => {
                  ...
                  return (
                    <button
                      ...
                      className="px-4 py-2.5 rounded-lg font-medium cursor-pointer transition-all duration-200"
                      style={{
                        fontSize: '0.9375rem',
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span style={{ fontSize: '0.9375rem', lineHeight: 1.7, color: '#475569' }}>
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 py-4 rounded-xl font-bold cursor-pointer transition-all duration-300"
              style={{
                fontSize: '1.0625rem',
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              <a
                ...
                style={{ fontSize: '0.9375rem', color: '#334155', textDecoration: 'none' }}
