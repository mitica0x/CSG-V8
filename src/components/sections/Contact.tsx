...
export default function Contact() {
  ...
  const inp = (name: string): React.CSSProperties => (focused === name ? focusedInput : baseInput);
          ...
          >
            <div
              ...
              style={{
                ...
                border: "1px solid rgba(91,168,181,0.3)",
              }}
            >
            ...
            <p style={{ color: "#8892a4" }}>
              We'll be in touch shortly. Confidential handling guaranteed.
            </p>
          </motion.div>
        ) : (
          <motion.form
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  {stages.map((s) => (
                    <option key={s} value={s} style={{ background: "#0a0f1e" }}>
                      {s}
                    </option>
                  ))}
                </select>
            ...
            <div>
              ...
              >
                ...
                {budgets.map((b) => (
                  <option key={b} value={b} style={{ background: "#0a0f1e" }}>
                    {b}
                  </option>
                ))}
              </select>
            ...
            <div>
              ...
              <label
                ...
                onMouseEnter={(e) =>
                  ((e.currentTarget as HTMLElement).style.borderColor = "rgba(91,168,181,0.28)")
                }
                onMouseLeave={(e) =>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                required
                className="mt-0.5"
                style={{ accentColor: "#5BA8B5" }}
              />
              <span className="text-xs leading-relaxed" style={{ color: "#8892a4" }}>
                I agree to C<span style={{ color: "#5BA8B5" }}>0</span>insiglieri handling my
                information with full confidentiality. No spam. No sharing. Fast response
                guaranteed.
              </span>
            </label>
            ...
            <button
              ...
              onMouseEnter={(e) =>
                ((e.currentTarget as HTMLElement).style.boxShadow =
                  "0 0 50px rgba(91,168,181,0.65)")
              }
              onMouseLeave={(e) =>
                ((e.currentTarget as HTMLElement).style.boxShadow =
                  "0 0 28px rgba(91,168,181,0.38)")
              }
            >
              <Send size={15} />
              Submit Project
