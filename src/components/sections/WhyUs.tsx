...
const tiles = [
  ...
  { value: '4,000+', label: 'VCs in Network', desc: 'Direct access to capital and decision-makers' },
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2
            className="font-bold"
            style={{ fontSize: 'clamp(1.75rem, 3.5vw, 3rem)', color: '#f8fafc', letterSpacing: '-0.02em' }}
          >
            Not consultants.{' '}
            <span className="gradient-cyan">Operators with skin in the game.</span>
          </h2>
        </motion.div>
