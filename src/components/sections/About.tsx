...
function StatCard({ stat, active }: { stat: (typeof stats)[0]; active: boolean }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{
        borderColor: "rgba(91,168,181,0.3)",
        boxShadow: "0 0 25px rgba(91,168,181,0.08)",
      }}
      transition={{ duration: 0.3 }}
    >
      <p className="stat-number text-3xl md:text-4xl mb-2">
        {stat.text ? stat.text : stat.isYear ? count || stat.value : count + stat.suffix}
      </p>
      <p
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          >
            ...
            >
              We transform <span className="gradient-cyan">ZERO into ONE</span>
            </h2>
            ...
            <div className="space-y-6">
              ...
              <p className="leading-relaxed" style={{ color: "#8892a4" }}>
                ...
                CEX &amp; DEX listing, ORM, smart contracts, and other critical functions — all
                under one management with synced vision.
              </p>
              <p className="leading-relaxed" style={{ color: "#8892a4" }}>
          ...
          <div>
            ...
            >
              <p className="text-sm leading-relaxed" style={{ color: "#8892a4" }}>
                ...
                From the whitepaper to the token launch, from legal to marketing, from smart
                contract to the POS terminal at a 120k-person festival.
