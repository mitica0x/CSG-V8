      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        >
          ...
          <h2 style={{ ...h2Style, marginBottom: 20 }}>
            We transform <span className="gradient-cyan">ZERO</span> into{" "}
            <span className="gradient-cyan">ONE</span>
          </h2>

          <p
            style={{ ...inter, fontSize: 14, color: "#8892a4", lineHeight: 1.7, marginBottom: 16 }}
          >
            C<span style={{ color: "#5BA8B5" }}>0</span>insiglieri is a AI-native financial
            infrastructure builder built to help founders, startups, and businesses move from
            concept to reality.
          </p>
          <p style={{ ...inter, fontSize: 14, color: "#8892a4", lineHeight: 1.7 }}>
            ...
            trading, networking, crypto payments, tokenomics, CEX &amp; DEX listing, ORM, and smart
            contracts — all under one management with synced vision.
          </p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <Eyebrow color="#7B5EA7">
            Why C<span style={{ color: "#5BA8B5" }}>0</span>insiglieri
          </Eyebrow>

          <h2 style={{ ...h2Style, marginBottom: 24 }}>
            Not consultants. <span className="gradient-purple">Operators</span> with skin in the
            game.
          </h2>
          ...
          <div className="flex flex-col gap-4">
            {points.map((p) => (
              <div key={p.title} style={{ ...cardStyle, background: "rgba(255,255,255,0.025)" }}>
                ...
                <p style={{ ...inter, fontSize: 13, color: "#8892a4", lineHeight: 1.55 }}>
                  {p.desc}
                </p>
              </div>
            ))}
