...
export default function Hero() {
  return (
    ...
    >
      ...
      <ThreeHero className="absolute inset-0 w-full h-full" style={{ opacity: 0.85 }} />
        ...
        <motion.div variants={container} initial="hidden" animate="visible">
          ...
          <motion.div variants={item} className="flex flex-wrap justify-center gap-5 mb-14">
            ...
            <button
              ...
              onMouseEnter={(e) =>
                ((e.currentTarget as HTMLElement).style.boxShadow = "0 0 50px rgba(91,168,181,0.7)")
              }
              onMouseLeave={(e) =>
                ((e.currentTarget as HTMLElement).style.boxShadow =
                  "0 0 28px rgba(91,168,181,0.45)")
              }
            >
              Start a Project
            </button>
          ...
          <motion.div
            variants={item}
            className="flex flex-wrap justify-center items-center gap-x-10 gap-y-3 mb-6"
          >
            {partners.map((p) => (
              <span
                key={p}
      ...
      <motion.button
        ...
        transition={{
          ...
          y: { repeat: Infinity, duration: 2.2, ease: "easeInOut", delay: 1 },
        }}
      >
        <ChevronDown size={20} />
      </motion.button>
